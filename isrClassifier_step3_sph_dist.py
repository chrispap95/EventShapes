...
CrossSection_sig = integrated_Luminosity*1./N_events_sig
...
ax.hist(sph_bkg_allTracks, bins=25, range=(0, 1), weights=CrossSection_bkg, histtype='step',
        density=True, label='all tracks', color=colorVal, linestyle='-')
ax.hist(sph_sig_allTracks, bins=25, range=(0, 1), weights=CrossSection_sig, histtype='step', density=True, color=colorVal, linestyle=':')
for i in range(3):
    colorVal = scalarMap.to_rgba(values[i+1])
    ax.hist(sph_bkg_dPhi[:,i], bins=25, range=(0, 1), weights=CrossSection_bkg, histtype='step',
            density=True, label='$|\Delta\phi|>%.2f$'%(dPhiValues[i]), color=colorVal, linestyle='-')
    ax.hist(sph_sig_dPhi[:,i], bins=25, range=(0, 1), weights=CrossSection_sig, histtype='step', density=True, color=colorVal, linestyle=':')
#for i in range(3):
...
ax.hist(sph_bkg_leadPt, bins=25, range=(0, 1), weights=CrossSection_bkg, histtype='step',
        density=True, label='lead Pt jet', color=colorVal, linestyle='-')
ax.hist(sph_sig_leadPt, bins=25, range=(0, 1), weights=CrossSection_sig, histtype='step', density=True, color=colorVal, linestyle=':')
colorVal = scalarMap.to_rgba(values[8])
ax.hist(sph_bkg_highMult, bins=25, range=(0, 1), weights=CrossSection_bkg, histtype='step',
        density=True, label='high mult. jet', color=colorVal, linestyle='-')
ax.hist(sph_sig_highMult, bins=25, range=(0, 1), weights=CrossSection_sig, histtype='step', density=True, color=colorVal, linestyle=':')
