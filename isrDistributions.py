...
ax.hist(dphi_fromScalar, bins=20, density=True, color='b', label='scalar', histtype='step')
ax.hist(dphi_ISR, bins=20, density=True, color='y', label='isr', histtype='step')
ax.hist(dphi_fromScalar_bst, bins=20, density=True, color='r', label='scalar boosted', histtype='step')
ax.hist(dphi_ISR_bst, bins=20, density=True, color='c', label='isr boosted', histtype='step')
#ax.set_xlim([0,1])
