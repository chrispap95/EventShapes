...
evtShape = np.concatenate(
    (evtShape_HT1000to1500, evtShape_HT1500to2000, evtShape_HT2000toInf)
)
evtShape1 = np.concatenate(
    (evtShape1_HT1000to1500, evtShape1_HT1500to2000, evtShape1_HT2000toInf)
)
evtShape2 = np.concatenate(
    (evtShape2_HT1000to1500, evtShape2_HT1500to2000, evtShape2_HT2000toInf)
)
evtShape3 = np.concatenate(
    (evtShape3_HT1000to1500, evtShape3_HT1500to2000, evtShape3_HT2000toInf)
)
evtShape4 = np.concatenate(
    (evtShape4_HT1000to1500, evtShape4_HT1500to2000, evtShape4_HT2000toInf)
)
evtShape5 = np.concatenate(
    (evtShape5_HT1000to1500, evtShape5_HT1500to2000, evtShape5_HT2000toInf)
)
