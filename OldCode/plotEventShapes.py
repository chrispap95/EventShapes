...
ax.hist(
    evtShape, bins=25, range=(0, 1), histtype="step", label="minus 0", color=colorVal
)
...
ax.hist(
    evtShape2, bins=25, range=(0, 1), histtype="step", label="minus 10", color=colorVal
)
colorVal = scalarMap.to_rgba(values[2])
ax.hist(
    evtShape3,
