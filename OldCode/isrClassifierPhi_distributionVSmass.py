...
hist_400_suep = bh.Histogram(bh.axis.Regular(100, 0, math.pi))
hist_400_isr = bh.Histogram(bh.axis.Regular(100, 0, math.pi))
hist_750_suep = bh.Histogram(bh.axis.Regular(100, 0, math.pi))
hist_750_isr = bh.Histogram(bh.axis.Regular(100, 0, math.pi))
hist_1000_suep = bh.Histogram(bh.axis.Regular(100, 0, math.pi))
hist_1000_isr = bh.Histogram(bh.axis.Regular(100, 0, math.pi))
...
ax.plot(hist_400_suep.axes[0].centers, hist_400_suep.view()/hist_400_suep.sum(), drawstyle='steps', color='b', linestyle='-', label='mMed 400 GeV');
ax.plot(hist_400_isr.axes[0].centers, hist_400_isr.view()/hist_400_suep.sum(), drawstyle='steps', color='b', linestyle='--');
ax.plot(hist_750_suep.axes[0].centers, hist_750_suep.view()/hist_750_suep.sum(), drawstyle='steps', color='r', linestyle='-', label='mMed 750 GeV');
ax.plot(hist_750_isr.axes[0].centers, hist_750_isr.view()/hist_750_suep.sum(), drawstyle='steps', color='r', linestyle='--');
ax.plot(hist_1000_suep.axes[0].centers, hist_1000_suep.view()/hist_1000_suep.sum(), drawstyle='steps', color='g', linestyle='-', label='mMed 1000 GeV');
ax.plot(hist_1000_isr.axes[0].centers, hist_1000_isr.view()/hist_1000_suep.sum(), drawstyle='steps', color='g', linestyle='--');
