...
# Get files
with open("QCD_HT700to1000_altBeta.p", "rb") as f:
    ...
    sph_HT700to1000_leadPt_ak4_suep = pickle.load(f)
    sph_HT700to1000_leadPt_ak4_isr = pickle.load(f)
    sph_HT700to1000_noLowMult = pickle.load(f)
    beta_HT700to1000 = pickle.load(f)
    beta1_HT700to1000 = pickle.load(f)
    beta2_HT700to1000 = pickle.load(f)
    trkMlt_HT700to1000 = pickle.load(f)

with open("QCD_HT1000to1500_altBeta.p", "rb") as f:
    ...
    sph_HT1000to1500_leadPt_ak4_suep = pickle.load(f)
    sph_HT1000to1500_leadPt_ak4_isr = pickle.load(f)
    sph_HT1000to1500_noLowMult = pickle.load(f)
    beta_HT1000to1500 = pickle.load(f)
    trkMlt_HT1000to1500 = pickle.load(f)

with open("QCD_HT1500to2000_altBeta.p", "rb") as f:
    ...
    sph_HT1500to2000_leadPt_ak4_suep = pickle.load(f)
    sph_HT1500to2000_leadPt_ak4_isr = pickle.load(f)
    sph_HT1500to2000_noLowMult = pickle.load(f)
    beta_HT1500to2000 = pickle.load(f)
    trkMlt_HT1500to2000 = pickle.load(f)

with open("QCD_HT2000toInf_altBeta.p", "rb") as f:
    ...
    sph_HT2000toInf_leadPt_ak4_suep = pickle.load(f)
    sph_HT2000toInf_leadPt_ak4_isr = pickle.load(f)
...
N_events = np.concatenate(
    (
        N_events_HT700to1000,
        N_events_HT1000to1500,
        N_events_HT1500to2000,
        N_events_HT2000toInf,
    )
)
CrossSection = np.concatenate(
    (
        CrossSection_HT700to1000,
        CrossSection_HT1000to1500,
        CrossSection_HT1500to2000,
        CrossSection_HT2000toInf,
    )
)
HT = np.concatenate((HT_HT700to1000, HT_HT1000to1500, HT_HT1500to2000, HT_HT2000toInf))
sph_allTracks = np.concatenate(
    (
        sph_HT700to1000_allTracks,
        sph_HT1000to1500_allTracks,
        sph_HT1500to2000_allTracks,
        sph_HT2000toInf_allTracks,
    )
)
sph_dPhi = np.concatenate(
    (
        sph_HT700to1000_dPhi,
        sph_HT1000to1500_dPhi,
        sph_HT1500to2000_dPhi,
        sph_HT2000toInf_dPhi,
    )
)
sph_relE = np.concatenate(
    (
        sph_HT700to1000_relE,
        sph_HT1000to1500_relE,
        sph_HT1500to2000_relE,
        sph_HT2000toInf_relE,
    )
)
sph_highMult = np.concatenate(
    (
        sph_HT700to1000_highMult,
        sph_HT1000to1500_highMult,
        sph_HT1500to2000_highMult,
        sph_HT2000toInf_highMult,
    )
)
sph_leadPt = np.concatenate(
    (
        sph_HT700to1000_leadPt,
        sph_HT1000to1500_leadPt,
        sph_HT1500to2000_leadPt,
        sph_HT2000toInf_leadPt,
    )
)
sph_leadPt_ak4_suep = np.concatenate(
    (
        sph_HT700to1000_leadPt_ak4_suep,
        sph_HT1000to1500_leadPt_ak4_suep,
        sph_HT1500to2000_leadPt_ak4_suep,
        sph_HT2000toInf_leadPt_ak4_suep,
    )
)
sph_leadPt_ak4_isr = np.concatenate(
    (
        sph_HT700to1000_leadPt_ak4_isr,
        sph_HT1000to1500_leadPt_ak4_isr,
        sph_HT1500to2000_leadPt_ak4_isr,
        sph_HT2000toInf_leadPt_ak4_isr,
    )
)
sph_noLowMult = np.concatenate(
    (
        sph_HT700to1000_noLowMult,
        sph_HT1000to1500_noLowMult,
        sph_HT1500to2000_noLowMult,
        sph_HT2000toInf_noLowMult,
    )
)
beta = np.concatenate(
    (beta_HT700to1000, beta_HT1000to1500, beta_HT1500to2000, beta_HT2000toInf)
)
trkMlt = np.concatenate(
    (trkMlt_HT700to1000, trkMlt_HT1000to1500, trkMlt_HT1500to2000, trkMlt_HT2000toInf)
)

with open("QCD_altbeta.p", "wb") as f:
