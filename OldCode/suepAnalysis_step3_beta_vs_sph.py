...
sph_bkg_noCut = np.concatenate(
    (sph_HT1000to1500_noCut, sph_HT1500to2000_noCut, sph_HT2000toInf_noCut)
)
...
ax.scatter(
    beta_bkg_abs[:10000], sph_bkg_dPhi[:10000, 0], s=2, label="bkg", color=colorVal
)
...
ax.text(
    right,
    top,
    "signal is mMed%d_darkPhoHad" % mMed,
