...
ax2.plot(
    sphericitySpace, nEntr_sig[:, i], label="signal", color=colorVal, linestyle=":"
)
i = 12
colorVal = scalarMap.to_rgba(values[1])
...
ax2.plot(
    sphericitySpace,
    nEntr_bkg[:, numberOfCases_relE_dPhi + 1],
    color=colorVal,
    linestyle="-",
    linewidth=2,
)
ax2.plot(
    sphericitySpace,
    nEntr_sig[:, numberOfCases_relE_dPhi + 1],
    color=colorVal,
    linestyle=":",
    linewidth=2,
)
...
ax2.plot(
    sphericitySpace,
    nEntr_bkg[:, numberOfCases_relE_dPhi + 2],
    color=colorVal,
    linestyle="-",
    linewidth=2,
)
ax2.plot(
    sphericitySpace,
    nEntr_sig[:, numberOfCases_relE_dPhi + 2],
    color=colorVal,
    linestyle=":",
    linewidth=2,
)
