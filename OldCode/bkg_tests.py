...
ns1, bins1, patches1 = ax.hist(ak.to_numpy(multiplicity_gen), bins=xbins, label='cmssw', weights=Weight, density=True, histtype='step', color='blue', linestyle='-')
ns2, bins2, patches2 = ax.hist(ak.to_numpy(multiplicity_pythia), bins=xbins, label='pythia', density=True, histtype='step', color='red', linestyle='-')
