...
beta_sig1000_abs = (
    beta_sig1000[:, 0] ** 2 + beta_sig1000[:, 1] ** 2 + beta_sig1000[:, 2] ** 2
)
beta_sig750_abs = (
    beta_sig750[:, 0] ** 2 + beta_sig750[:, 1] ** 2 + beta_sig750[:, 2] ** 2
)
beta_sig400_abs = (
    beta_sig400[:, 0] ** 2 + beta_sig400[:, 1] ** 2 + beta_sig400[:, 2] ** 2
)
