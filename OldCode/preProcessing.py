...
datasets = [
    base2
    + "PrivateSamples.SUEP_2018_mMed-1000_mDark-2_temp-2_decay-darkPhoHad_13TeV-pythia8_n-100_0_RA2AnalysisTree",
    base2
    + "PrivateSamples.SUEP_2018_mMed-1000_mDark-2_temp-2_decay-darkPho_13TeV-pythia8_n-100_0_RA2AnalysisTree",
    base1
    + "Autumn18.QCD_HT1000to1500_TuneCP5_13TeV-madgraphMLM-pythia8_RA2AnalysisTree",
    base1
    + "Autumn18.QCD_HT1500to2000_TuneCP5_13TeV-madgraphMLM-pythia8_RA2AnalysisTree",
    base1
    + "Autumn18.QCD_HT2000toInf_TuneCP5_13TeV-madgraphMLM-pythia8_RA2AnalysisTree",
]
...
for ievt in range(len(Tracks_x)):
    if ievt % 1000 == 0:
        print(
            "Processing event %d. Progress: %.2f%%" % (ievt, 100 * ievt / len(Tracks_x))
        )
