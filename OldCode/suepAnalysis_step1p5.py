# Script: suepAnalysis_step1p5.py
# Description:
#       Stitch fragments for each QCD bin. Output is one file per QCD bin.
...
for bin in bins:
    ...
    # Stitch data
    CrossSection_vec = np.concatenate(
        (
            CrossSection[0],
            CrossSection[1],
            CrossSection[2],
    ...
    HT_vec = np.concatenate(
        (HT[0], HT[1], HT[2], HT[3], HT[4], HT[5], HT[6], HT[7], HT[8], HT[9])
    )
    sph_allTracks_vec = np.concatenate(
        (
            sph_allTracks[0],
            sph_allTracks[1],
            sph_allTracks[2],
    ...
    sph_highMult_vec = np.concatenate(
        (
            sph_highMult[0],
            sph_highMult[1],
            sph_highMult[2],
    ...
    sph_leadPt_ak4_suep_vec = np.concatenate(
        (
            sph_leadPt_ak4_suep[0],
            sph_leadPt_ak4_suep[1],
            sph_leadPt_ak4_suep[2],
            sph_leadPt_ak4_suep[3],
            sph_leadPt_ak4_suep[4],
            sph_leadPt_ak4_suep[5],
            sph_leadPt_ak4_suep[6],
            sph_leadPt_ak4_suep[7],
            sph_leadPt_ak4_suep[8],
            sph_leadPt_ak4_suep[9],
        )
    )
    sph_leadPt_ak4_isr_vec = np.concatenate(
        (
            sph_leadPt_ak4_isr[0],
            sph_leadPt_ak4_isr[1],
            sph_leadPt_ak4_isr[2],
            sph_leadPt_ak4_isr[3],
            sph_leadPt_ak4_isr[4],
            sph_leadPt_ak4_isr[5],
            sph_leadPt_ak4_isr[6],
            sph_leadPt_ak4_isr[7],
            sph_leadPt_ak4_isr[8],
            sph_leadPt_ak4_isr[9],
        )
    )
    sph_noLowMult_vec = np.concatenate(
        (
            sph_noLowMult[0],
            sph_noLowMult[1],
            sph_noLowMult[2],
    ...
    beta_ak4_suep_vec = np.concatenate(
        (
            beta_ak4_suep[0],
            beta_ak4_suep[1],
            beta_ak4_suep[2],
    ...
    beta_ak4_isr_vec = np.concatenate(
        (
            beta_ak4_isr[0],
            beta_ak4_isr[1],
            beta_ak4_isr[2],
