...
ax2.hist(beta_bkg_abs, bins=bins, range=(min, max), weights=CrossSection_bkg, histtype='step',
...
for mass_sig in signalMasses:
    ...
    ax2.hist(beta_sig_abs, bins=bins, range=(min, max), weights=CrossSection_sig,
