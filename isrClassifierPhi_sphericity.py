...
ax.plot(hist_bb_0p1.axes[0].edges[:-1], hist_bb_0p1.view(), drawstyle='steps-post', color='g', linestyle='-', label='$|\Delta\phi|>0.1$ before boost');
...
ax.plot(hist_bb_0p7.axes[0].edges[:-1], hist_bb_0p7.view(), drawstyle='steps-post', color='y', linestyle='-', label='$|\Delta\phi|>0.7$ before boost');
...
ax.plot(hist_ab_0p1.axes[0].edges[:-1], hist_ab_0p1.view(), drawstyle='steps-post', color='g', linestyle='--', label='$|\Delta\phi|>0.1$ after boost');
...
ax.plot(hist_ab_0p7.axes[0].edges[:-1], hist_ab_0p7.view(), drawstyle='steps-post', color='y', linestyle='--', label='$|\Delta\phi|>0.7$ after boost');
ax.plot(hist_ideal.axes[0].edges[:-1], hist_ideal.view(), drawstyle='steps-post', color='black', linestyle='-', label='ideal case');
