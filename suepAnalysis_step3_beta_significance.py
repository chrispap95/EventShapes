...
ax1.plot(beta_space, significance[significanceMode], '.-',
        label='$\\beta$', color=colorVal)
ax1.set_xlabel('$\\beta$')
...
colorVal = scalarMap.to_rgba(values[0])
ax2.hist(beta_bkg_abs, bins=25, range=(0, 1), weights=CrossSection_bkg, histtype='step',
        color=colorVal, linestyle='-', linewidth=2)
ax2.hist(beta_sig_abs, bins=25, range=(0, 1), weights=CrossSection_sig, histtype='step',
        color=colorVal, linestyle=':', linewidth=2)
