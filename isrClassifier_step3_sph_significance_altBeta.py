...
# Get files
with open("QCD_altbeta.p", "rb") as f:
...
with open("mMed-%s_mDark-2_temp-2_decay-darkPhoHad_altbeta.p"%mass_sig, "rb") as f:
...
if applyTrkMltCut:
    ...
    sph_sig_leadPt_ak4_suep = sph_sig_leadPt_ak4_suep[trkMlt_sig > trkMlt_cut]
    sph_sig_leadPt_ak4_isr = sph_sig_leadPt_ak4_isr[trkMlt_sig > trkMlt_cut]
    ...
    sph_bkg_leadPt_ak4_suep = sph_bkg_leadPt_ak4_suep[trkMlt_bkg > trkMlt_cut]
    sph_bkg_leadPt_ak4_isr = sph_bkg_leadPt_ak4_isr[trkMlt_bkg > trkMlt_cut]
...
hist_sph_bkg_leadPt_ak4_suep = bh.Histogram(bh.axis.Regular(sphericityBins, 0, 1))
hist_sph_bkg_leadPt_ak4_isr = bh.Histogram(bh.axis.Regular(sphericityBins, 0, 1))
...
hist_sph_sig_leadPt_ak4_suep = bh.Histogram(bh.axis.Regular(sphericityBins, 0, 1))
hist_sph_sig_leadPt_ak4_isr = bh.Histogram(bh.axis.Regular(sphericityBins, 0, 1))
...
hist_sph_sig_leadPt_ak4_suep.fill(sph_sig_leadPt_ak4_suep, weight=xs_signal[mass_sig])
hist_sph_sig_leadPt_ak4_isr.fill(sph_sig_leadPt_ak4_isr, weight=xs_signal[mass_sig])
...
# Number of columns for efficiency: 6*(relE) + 6*(dphi) + 5 baseline methods + allTracks
nEntr_sig = np.zeros((sphericityBins,numberOfCases_relE_dPhi+5+1))
nEntr_bkg = np.zeros((sphericityBins,numberOfCases_relE_dPhi+5+1))
for i in range(1,sphericityBins+1):
    ...
    nEntr_sig[i-1,numberOfCases_relE_dPhi+2] = hist_sph_sig_leadPt_ak4_suep[::sum]-hist_sph_sig_leadPt_ak4_suep[:i:sum]
    nEntr_bkg[i-1,numberOfCases_relE_dPhi+2] = hist_sph_bkg_leadPt_ak4_suep[::sum]-hist_sph_bkg_leadPt_ak4_suep[:i:sum]
    nEntr_sig[i-1,numberOfCases_relE_dPhi+3] = hist_sph_sig_leadPt_ak4_isr[::sum]-hist_sph_sig_leadPt_ak4_isr[:i:sum]
    nEntr_bkg[i-1,numberOfCases_relE_dPhi+3] = hist_sph_bkg_leadPt_ak4_isr[::sum]-hist_sph_bkg_leadPt_ak4_isr[:i:sum]
    nEntr_sig[i-1,numberOfCases_relE_dPhi+4] = hist_sph_sig_highMult[::sum]-hist_sph_sig_highMult[:i:sum]
    nEntr_bkg[i-1,numberOfCases_relE_dPhi+4] = hist_sph_bkg_highMult[::sum]-hist_sph_bkg_highMult[:i:sum]
    nEntr_sig[i-1,numberOfCases_relE_dPhi+5] = hist_sph_sig_noLowMult[::sum]-hist_sph_sig_noLowMult[:i:sum]
    nEntr_bkg[i-1,numberOfCases_relE_dPhi+5] = hist_sph_bkg_noLowMult[::sum]-hist_sph_bkg_noLowMult[:i:sum]

significance = np.zeros((3,sphericityBins,numberOfCases_relE_dPhi+5+1))
for i in range(numberOfCases_relE_dPhi+5+1):
...
# Set colormap
#values = range(numberOfCases_relE_dPhi+3+1)
values = range(3)
...
ax1.plot(sphericitySpace, significance[significanceMode, :, 13], '.-',
        label='old beta', color=colorVal)
colorVal = scalarMap.to_rgba(values[1])
ax1.plot(sphericitySpace, significance[significanceMode, :, 14], '.-',
        label='ak4 suep', color=colorVal)
colorVal = scalarMap.to_rgba(values[2])
ax1.plot(sphericitySpace, significance[significanceMode, :, 15], '.-',
        label='ak4 isr', color=colorVal)
...
ax2.hist(sph_sig_leadPt, bins=25, range=(0, 1), weights=xs_signal[mass_sig]*np.ones(sph_sig_leadPt.size), histtype='step',
        color=colorVal, linestyle=':', linewidth=2)
colorVal = scalarMap.to_rgba(values[1])
ax2.hist(sph_bkg_leadPt_ak4_suep, bins=25, range=(0, 1), weights=CrossSection_bkg, histtype='step',
        color=colorVal, linestyle='-', linewidth=2)
ax2.hist(sph_sig_leadPt_ak4_suep, bins=25, range=(0, 1), weights=xs_signal[mass_sig]*np.ones(sph_sig_leadPt_ak4_suep.size), histtype='step',
        color=colorVal, linestyle=':', linewidth=2)
colorVal = scalarMap.to_rgba(values[2])
ax2.hist(sph_bkg_leadPt_ak4_isr, bins=25, range=(0, 1), weights=CrossSection_bkg, histtype='step',
        color=colorVal, linestyle='-', linewidth=2)
ax2.hist(sph_sig_leadPt_ak4_isr, bins=25, range=(0, 1), weights=xs_signal[mass_sig]*np.ones(sph_sig_leadPt_ak4_isr.size), histtype='step',
        color=colorVal, linestyle=':', linewidth=2)
